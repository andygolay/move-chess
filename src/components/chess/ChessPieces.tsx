...
export function WhiteKing({ className = "w-full h-full" }: PieceProps) {
  return (
...
export function BlackKing({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function WhiteQueen({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="#fff" stroke="#000" strokeLinejoin="round" strokeWidth="1.5">
        <path d="M8 12a2 2 0 1 1-4 0 2 2 0 1 1 4 0zm16.5-4.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0zm-13 0a2 2 0 1 1-4 0 2 2 0 1 1 4 0zm26 0a2 2 0 1 1-4 0 2 2 0 1 1 4 0zm6.5 4.5a2 2 0 1 1-4 0 2 2 0 1 1 4 0z" />
...
export function BlackQueen({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="#000" stroke="#000" strokeLinejoin="round" strokeWidth="1.5">
        <g stroke="none">
...
export function WhiteRook({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
...
export function BlackRook({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="#000" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
        ...
        <path d="M12 35.5h21m-20-4h19m-18-2h17m-17-13h17M11 14h23" fill="none" stroke="#fff" strokeLinejoin="miter" strokeWidth="1" />
      </g>
    </svg>
  );
}

export function WhiteBishop({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function BlackBishop({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function WhiteKnight({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function BlackKnight({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <g fill="none" fillRule="evenodd" stroke="#000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
...
export function WhitePawn({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill="#fff" stroke="#000" strokeLinecap="round" strokeWidth="1.5" />
    </svg>
  );
}

export function BlackPawn({ className = "w-full h-full" }: PieceProps) {
  return (
    <svg className={className} viewBox="0 0 45 45">
      <path d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z" fill="#000" stroke="#000" strokeLinecap="round" strokeWidth="1.5" />
    </svg>
  );
}
...
export default function ChessPiece({ pieceType, color, className }: ChessPieceProps) {
  ...
  switch (pieceType) {
    case 1: // Pawn
      return isWhite ? <WhitePawn className={className} /> : <BlackPawn className={className} />;
    case 2: // Knight
      return isWhite ? <WhiteKnight className={className} /> : <BlackKnight className={className} />;
    case 3: // Bishop
      return isWhite ? <WhiteBishop className={className} /> : <BlackBishop className={className} />;
    case 4: // Rook
      return isWhite ? <WhiteRook className={className} /> : <BlackRook className={className} />;
    case 5: // Queen
      return isWhite ? <WhiteQueen className={className} /> : <BlackQueen className={className} />;
    case 6: // King
      return isWhite ? <WhiteKing className={className} /> : <BlackKing className={className} />;
    default:
      return null;
  }
}
